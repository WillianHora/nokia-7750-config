[/]
A:admin@7750-SR1# admin show configuration  
...
# Generated 2025-10-08T23:16:05.4+00:00 by admin from 192.168.17.193
# Last modified 2025-10-08T23:13:09.2+00:00 by admin (MD-CLI) from 192.168.17.193
# Last saved 2025-10-08T23:14:30.8+00:00 by admin from 192.168.17.193
        ...
        security {
            ...
            user-params {
                local-user {
                    ...
                    user "ixc" {
                        password "$2y$10$gpNiY3Xzn9P56Q6O5c1vI.kufVe17UXKioDPVEU4gl4JtrZkcpodi"
                        access {
                            ssh-cli true
                        }
                        console {
...
persistent-indices {
    ...
    vrtr-if-id {
        router-name "5" interface-name "INTERNET" vrtr-id 1 if-index 4
        router-name "5" interface-name "PW-PORT" vrtr-id 1 if-index 5
        router-name "Base" interface-name "IXC-LINK" vrtr-id 1 if-index 2
        router-name "Base" interface-name "TO-FTP" vrtr-id 1 if-index 3
    }
...
# Finished 2025-10-08T23:16:05.5+00:00
